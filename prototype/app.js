...
const DEST_CARDS = [
  {name:'杭州',en:'Hangzhou',tagline:'西湖古寺 · 湿地与老城',days:'2—7 天',price:'多日游攻略',img:'assets/cities/hangzhou/west-lake-panorama.jpg',tags:['湖景','古寺','文博']},
  {name:'广州',en:'Guangzhou',tagline:'西关人文 · 珠江天际线',days:'2—7 天',price:'多日游攻略',img:'assets/cities/guangzhou/canton-tower.jpg',tags:['老城','展馆','夜景']} ,
    ...
    <section class="hero" id="hero">
      ...
      <div class="hero-content">
        ...
        <div class="hero-quick">
          <span>🔥 热门:</span>
          ${['杭州','广州','北京','上海','京都'].map(d=>`<button class="chip" data-act="quick" data-d="${d}">${d}</button>`).join('')}
        </div>
      </div>
    ...
    <div class="card s0-form">
      <div class="f-grid">
        <div class="field"><label>目的地</label><input id="f-dest" list="city-list" value="${esc(S.req.dest)}">
          <datalist id="city-list"><option value="京都"><option value="北京"><option value="上海"><option value="杭州"><option value="广州"></datalist></div>
  ...
  switch(act){
    ...
    case 'submit': {
      ...
      if(d){
        ...
        if(dest !== S.req.dest) toast('当前支持京都、北京、上海、杭州、广州，先为你显示京都。');
      }
