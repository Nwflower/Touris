...
const MEMORIES = [
  ...
  { id:'m15', text:'不喜欢团队体验课程（和服体验、茶道班）', type:'景点', scope:'long', cited:2, used:false,
    source:{ trip:'2025-06 京都 3 天', date:'2025-06-23', action:'你对「和服体验」点了不喜欢', quote:'不感兴趣' } },
  { id:'m16', text:'喜欢住二层以下带小庭院的旅馆', type:'住宿', scope:'long', cited:1, used:false,
    source:{ trip:'2025-06 京都 3 天', date:'2025-06-20', action:'你对一家町屋改造旅馆点了喜欢' } },
  { id:'m17', text:'偏好傍晚而非清晨游览寺庙', type:'节奏', scope:'long', cited:2, used:false,
    source:{ trip:'2025-06 京都 3 天', date:'2025-06-22', action:'你把清水寺从早上挪到了傍晚' } },
  { id:'m18', text:'不喜欢主题乐园', type:'景点', scope:'long', cited:1, used:false,
  ...
  { id:'m20', text:'喜欢当地人开的小馆，不追米其林', type:'餐饮', scope:'long', cited:3, used:true,
...
const REASON_TO_MEMORY = {
  '太赶':        { text:'不喜欢一天塞太多景点', type:'节奏' },
  '太远':        { text:'不喜欢跨城长距离移动', type:'交通' },
  '我晕博物馆':  { text:'我晕博物馆（大型综合馆）', type:'景点' },
  '人太多':      { text:'不喜欢人多需要排队的地方', type:'景点' },
  '不感兴趣':    { text:'对这类景点兴趣低', type:'景点' },
  '不想早起':    { text:'不喜欢早起赶路', type:'节奏' },
  '太早出门':    { text:'不喜欢早起赶路', type:'节奏' },
  '换乘太多':    { text:'不喜欢一天里换两次交通枢纽', type:'交通' },
  '太松了':      { text:'希望行程再紧凑一点', type:'节奏' },
  '要排队':      { text:'不喜欢需要排队超过 30 分钟的店', type:'餐饮' },
  '太贵':        { text:'不接受高价游客向餐厅', type:'餐饮' },
  '游客向':      { text:'不喜欢游客向餐厅，偏好本地小馆', type:'餐饮' },
  '不合口味':    { text:'不喜欢这类菜式', type:'餐饮' },
  '离得远':      { text:'希望吃饭地点在行程动线上', type:'餐饮' },
  '周边没吃的':  { text:'偏好住在有夜间小馆的街区', type:'住宿' },
  '太吵':        { text:'不喜欢住在喧闹商圈', type:'住宿' },
  '不喜欢商圈':  { text:'偏好住生活街区而非商圈中心', type:'住宿' },
  '不需要休息':  { text:'不需要午后长休息', type:'节奏' },
  '浪费时间':    { text:'不喜欢行程里的空档', type:'节奏' },
  '想多待会儿':  { text:'喜欢在喜欢的地方多停留，别赶时间', type:'节奏' },
  '正是我想要的':{ text:'喜欢这类景点', type:'景点' },
  '安静':        { text:'喜欢安静的自然与庭园景观', type:'景点' },
  '风景好':      { text:'喜欢有景观视野的地点', type:'景点' },
  '想吃这个':    { text:'喜欢这类餐饮体验', type:'餐饮' },
  '本地感':      { text:'喜欢当地人开的小馆，不追米其林', type:'餐饮' },
  '不用排队':    { text:'偏好不用排队的餐厅', type:'餐饮' },
  '性价比高':    { text:'喜欢性价比高的本地餐厅', type:'餐饮' },
  '节奏舒服':    { text:'喜欢一天 2-3 个景点的节奏', type:'节奏' },
  '不用早起':    { text:'喜欢 9 点后出发的行程', type:'节奏' },
  '走得不多':    { text:'偏好日均步行 8km 以内', type:'节奏' },
  '位置合适':    { text:'喜欢步行可达主要动线的住宿', type:'住宿' },
  '周边有夜宵':  { text:'偏好住在有夜间小馆的街区', type:'住宿' },
  '有庭院':      { text:'喜欢带庭院的小型旅馆', type:'住宿' },
